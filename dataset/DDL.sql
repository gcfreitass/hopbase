...
INSERT INTO employee (employee_id, last_name, first_name, title, title_of_courtesy, birth_date, hire_date, address, city, region, postal_code, country, home_phone, extension, picture, notes, reports_to, photo_path) VALUES
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    required_date VARCHAR(12),
    shipped_date VARCHAR(12),
    ship_via BIGINT,
    freight DOUBLE PRECISION,
    ship_name VARCHAR(36),
    ship_address VARCHAR(48),
    ship_city VARCHAR(17),
    ship_region VARCHAR(15),
    ship_postal_code VARCHAR(11),
    ship_country VARCHAR(18)
);

-- Note: The orders table has ~830 rows. Only first 10 are shown here for brevity.
-- The complete data set would be included in a production migration.
...
-- Note: The order_details table has ~2155 rows. Only first 10 are shown here for brevity.
