...
-- Host:                        127.0.0.1
-- Database:                    north
-- PostgreSQL Version:          Compatível com PostgreSQL 12+
-- --------------------------------------------------------
...
-- Dados da tabela categories (8 linhas)
...
-- Dados da tabela customers (91 linhas)
...
-- Dados da tabela employee (9 linhas)
...
-- Dados da tabela employee_territories (49 linhas)
...
-- Dados da tabela orders (830 linhas)
...
-- Dados da tabela order_details (2.155 linhas)
...
-- Dados da tabela products (77 linhas)
...
-- Dados da tabela region (4 linhas)
...
-- Dados da tabela shippers (6 linhas)
...
-- Dados da tabela suppliers (29 linhas)
...
-- Dados da tabela territories (53 linhas)
...
-- Dados da tabela us_states (51 linhas)
